...
marauroa.rpobjectFactory["thieving_monkey"] = marauroa.util.fromProto(marauroa.rpobjectFactory["domesticanimal"], {
	imagePath: "/data/sprites/thieving_monkey.png",
	largeWeight: 20,
	// A default title that does not have an underscore. Named pets set their
	// own title anyway
	title: "thieving monkey"
});
